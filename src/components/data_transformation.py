...
class Datatranformation:
    def __init__(self):
        self.datatransformation_config=Datatranformconfig()
        
    def get_data_transformer_object(self):
        '''
        this function is responsile for datatransformation baesd on different data
        '''
        ...
        'test_preparation_course'
            ...
            logging.info("encoding and standardisation completed") 
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try:
            ...
            logging.info(
                f"applying the preprocessing on train and test dataframe"
            )
            ...
            # save_object=(self.datatransformation_config.preprocessor_obj_file_path)
            # obj=preprocessing_obj
